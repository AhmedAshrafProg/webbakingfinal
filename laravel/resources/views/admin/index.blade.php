              ...
              <div class="col-xl-3 col-sm-6 m-t35">
                   <div class="card card-coin">
                        <div class="card-body text-center">
                             ...
                             <h2 class="text-black mb-2 font-w600">services</h2>
                             <h2 class="text-black mb-2 font-w600">{{ count($service) }}</h2>
                             <p class="mb-0 fs-14">
              ...
              <div class="col-xl-3 col-sm-6 m-t35">
                   <div class="card card-coin">
                        <div class="card-body text-center">
                             ...
                             <h2 class="text-black mb-2 font-w600">{{ count($courses) }}</h2>
                             <p class="mb-0 fs-13">
                                  <svg width="29" height="22" viewBox="0 0 29 22" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="col-xl-3 col-sm-6 m-t35">
                   <div class="card card-coin">
                        <div class="card-body text-center">
                             ...
                             <h2 class="text-black mb-2 font-w600">Messages</h2>
                             <h2 class="text-black mb-2 font-w600">{{ count($message) }}</h2>
                             <p class="mb-0 fs-14">
                                  <svg width="29" height="22" viewBox="0 0 29 22" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="col-xl-3 col-sm-6 m-t35">
                   <div class="card card-coin">
                        <div class="card-body text-center">
                             ...
                             <h2 class="text-black mb-2 font-w600">projects</h2>
                             <h2 class="text-black mb-2 font-w600">{{ count($projects) }}</h2>
                             <p class="mb-0 fs-14">
                                  <svg width="29" height="22" viewBox="0 0 29 22" fill="none" xmlns="http://www.w3.org/2000/svg">
